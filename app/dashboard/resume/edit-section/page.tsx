"use client";
import { updateSection, getSectionCount } from "@/app/services";
...
function EditSection() {
	...
	const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
		...
		await updateSection(section).then((response) => console.log(response));
		handleReset();
	};
			...
			<form onSubmit={handleSubmit}>
				...
				<div className="border-b border-gray-900/10 pb-12">
					...
					<p className="mt-1 text-sm leading-6 text-gray-600">
						A section consists of a required Title, optional Header, optional SubHeader, and optional
						content.
					</p>
					...
					<div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
						...
						<div className="sm:col-span-4">
							<label htmlFor="subheader" className="block text-sm font-medium leading-6 text-gray-900">
								SubHeader
							</label>
							<div className="mt-2">
								<input
